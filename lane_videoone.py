...
class Lane:
  ...
  def stabilize_steering_angle(self, curr_steering_angle, new_steering_angle, num_of_lane_lines, max_angle_deviation_two_lines=10, max_angle_deviation_one_lane=1):
    ...
    if abs(angle_deviation) > max_angle_deviation:
        ...
        print(stabilized_steering_angle,'siba')                                    
    else:
  ...
  def display_curvature_offset(self, frame=None, plot=False):
    ...
    img = np.zeros((int(self.height), int(self.width) , 3), np.uint8) #生成一个空灰度图像
  ...
  def overlay_lane_lines(self, plot=False):
    ...
    imgofpath = np.zeros((self.height, self.width, 3), np.uint8) #生成一个空灰度图像                              
    ...
    #contours = np.array([(PT5-100, PT6),(PT5+100, PT6), (PT3+100, PT4) ,(PT1+100, self.height),(PT1-100, self.height) , (PT3-100, PT4)])
   # contours = np.array([[PT3, PT4] ,[PT3+300, PT4], [PT1+300, PT2], [int(self.width/2) +300, self.height],[int(self.width/2), self.height ] ,[PT1, PT2] ])
